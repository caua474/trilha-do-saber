...
const STUDY_TECHNIQUES: StudyTechnique[] = [
  ...
  },
  {
    ...
    exemploPratico: 'Use os Flashcards do app inteligente para revisar termos errados 1 dia depois, 3 dias depois e 1 semana depois.'
  },
  {
    id: 'active_recall',
