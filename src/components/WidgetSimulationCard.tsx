    ...
    <div className="bg-slate-900 border border-purple-500/30 rounded-3xl p-6 text-white shadow-xl space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
        <p className="text-xs text-slate-400">
          💡 <strong>Como instalar:</strong> Mantenha o dedo pressionado na tela inicial do seu celular, toque em <strong>+ (Widgets)</strong> e pesquise por <strong>CFJVMG</strong>.
        </p>
