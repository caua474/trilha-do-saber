...
interface RoutineBlock {
  ...
  categoria: 'Escola / Cursinho' | 'Estudo app inteligente' | 'Exercícios & Simulados' | 'Lazer & Descanso';
  concluido?: boolean;
}
...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  'Estudo app inteligente': { bg: 'bg-indigo-100 dark:bg-indigo-950/80', text: 'text-indigo-800 dark:text-indigo-300', border: 'border-indigo-300' },
...
const INITIAL_BLOCKS: RoutineBlock[] = [
  ...
  { id: '2', dia: 'Seg', horario: '14:00 - 16:00', materiaOuAtividade: 'Matemática & Exercícios TRI', categoria: 'Estudo app inteligente', concluido: true },
  ...
  { id: '6', dia: 'Ter', horario: '14:00 - 16:30', materiaOuAtividade: 'Física & Flashcards', categoria: 'Estudo app inteligente' },
  { id: '7', dia: 'Qua', horario: '14:00 - 17:00', materiaOuAtividade: 'Simulado Parcial ENEM', categoria: 'Exercícios & Simulados' },
  { id: '8', dia: 'Qui', horario: '14:00 - 16:00', materiaOuAtividade: 'Biologia & Química', categoria: 'Estudo app inteligente' },
  { id: '9', dia: 'Sex', horario: '14:00 - 16:00', materiaOuAtividade: 'História e Geografia', categoria: 'Estudo app inteligente' },
  { id: '10', dia: 'Sáb', horario: '09:00 - 12:00', materiaOuAtividade: 'Revisão Espaçada Leitner', categoria: 'Estudo app inteligente' },
...
export const WeeklyRoutinePlannerSection: React.FC = () => {
  ...
  const [categoriaAdd, setCategoriaAdd] = useState<'Escola / Cursinho' | 'Estudo app inteligente' | 'Exercícios & Simulados' | 'Lazer & Descanso'>('Estudo app inteligente');
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div>
            ...
            >
              ...
              <option value="Estudo app inteligente">Estudo app inteligente</option>
