    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          >
            O <strong>app inteligente</strong> precisa de autorização para usar o seu microfone em português brasileiro. Assim, você pode ditar dúvidas para a Professora Gabi, gravar suas explicações no Método Feynman e praticar respostas orais.
          </p>
